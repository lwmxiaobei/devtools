...
export const toolSeoConfigs: Record<string, string[]> = {
    ...
    'json-diff': ['JSON比较', 'JSON对比', 'JSON差异对比', 'JSON diff', 'JSON比较工具'],
    ...
    'json-to-go': ['JSON转Go', 'JSON转Golang', 'Go结构体生成', 'JSON to Go', 'Go struct'],
    'json-to-ts': ['JSON转TypeScript', 'TS类型生成', 'JSON to TypeScript', 'TypeScript interface', 'TS类型定义'],
    'lottie-preview': ['Lottie预览', 'Lottie动画', 'Lottie JSON', '动画预览'],
    'base64': ['Base64编码', 'Base64解码', '图片Base64', 'Base64转换'],
    'hex-encode': ['Hex编码', 'Hex解码', '十六进制转换', '文本转Hex', 'Hex转文本', '16进制编码'],
    'aes': ['AES加密', 'AES解密', 'AES-128', 'AES-256', 'CBC模式', 'ECB模式', '对称加密'],
    'rsa': ['RSA加密', 'RSA解密', 'RSA密钥对', '非对称加密', '公钥加密', '私钥解密', 'RSA工具'],
    'unicode': ['Unicode编码', 'Unicode解码', 'Unicode转换', '\\u编码', 'Unicode转中文', '中文转Unicode'],
    'ascii': ['ASCII编码', 'ASCII解码', 'ASCII码表', '字符转ASCII', 'ASCII转字符', '二进制转换'],
    'punycode': ['Punycode编码', 'Punycode解码', '国际化域名', 'IDN转换', '域名编码', 'xn--'],
    'hmac': ['HMAC计算', 'HMAC-SHA256', 'HMAC-MD5', '消息认证码', 'MAC计算', 'API签名'],
    'caesar': ['凯撒密码', 'ROT13', '移位密码', '加密解密', 'Caesar cipher', '古典密码'],
    'morse': ['摩斯密码', '摩斯电码', 'Morse code', '点划编码', 'SOS', '电报编码'],
    'rail-fence': ['栅栏密码', '篱笆密码', '栅栏加密', 'Rail fence', '古典密码', '换位密码'],
    'base32': ['Base32编码', 'Base32解码', 'Base58编码', 'Base58解码', 'Base编码转换'],
    'crc': ['CRC校验', 'CRC16', 'CRC32', '循环冗余校验', '校验码计算', '数据校验'],
    ...
    'html-to-image': ['HTML转图片', 'HTML截图', 'HTML渲染图片', '网页转图片', 'HTML生成图片', '代码转图片'],
...
export const toolSeoConfigsEn: Record<string, string[]> = {
    ...
    'json-diff': ['JSON compare', 'JSON diff', 'JSON comparison', 'compare JSON', 'JSON difference'],
    ...
    'json-to-go': ['JSON to Go', 'JSON to Go struct', 'Go struct generator', 'generate Go from JSON'],
    'json-to-ts': ['JSON to TypeScript', 'TypeScript interface generator', 'generate TS types from JSON', 'TypeScript type definition'],
    ...
    'hex-encode': ['Hex encode', 'Hex decode', 'hexadecimal converter', 'text to hex', 'hex to text', 'hex string'],
    'aes': ['AES encrypt', 'AES decrypt', 'AES-128', 'AES-256', 'CBC mode', 'ECB mode', 'symmetric encryption'],
    'rsa': ['RSA encrypt', 'RSA decrypt', 'RSA key pair', 'asymmetric encryption', 'public key', 'private key', 'RSA tool'],
    'unicode': ['Unicode encode', 'Unicode decode', 'Unicode converter', '\\u encoding', 'Unicode to text', 'text to Unicode'],
    'ascii': ['ASCII encode', 'ASCII decode', 'ASCII table', 'char to ASCII', 'ASCII to char', 'binary converter'],
    'punycode': ['Punycode encode', 'Punycode decode', 'internationalized domain', 'IDN converter', 'domain encoding', 'xn--'],
    'hmac': ['HMAC calculator', 'HMAC-SHA256', 'HMAC-MD5', 'message authentication', 'MAC calculator', 'API signature'],
    'caesar': ['Caesar cipher', 'ROT13', 'shift cipher', 'encrypt decrypt', 'classic cipher', 'substitution cipher'],
    'morse': ['Morse code', 'Morse encoder', 'Morse decoder', 'dot dash', 'SOS', 'telegraph code'],
    'rail-fence': ['Rail fence cipher', 'zigzag cipher', 'transposition cipher', 'classic cipher', 'rail fence encrypt'],
    'base32': ['Base32 encode', 'Base32 decode', 'Base58 encode', 'Base58 decode', 'Base encoding'],
    'crc': ['CRC checksum', 'CRC16', 'CRC32', 'cyclic redundancy check', 'checksum calculator', 'data verification'],
    ...
    'html-to-image': ['HTML to image', 'HTML screenshot', 'render HTML to image', 'webpage to image', 'HTML to PNG', 'code to image'],
...
export const toolNamesEn: Record<string, { name: string; description: string }> = {
    ...
    'hex-encode': { name: 'Hex Encode/Decode', description: 'Convert between text and hexadecimal' },
    'aes': { name: 'AES Encrypt/Decrypt', description: 'AES symmetric encryption and decryption tool' },
    'rsa': { name: 'RSA Encrypt/Decrypt', description: 'RSA asymmetric encryption with key pair generation' },
    'unicode': { name: 'Unicode Encode/Decode', description: 'Convert between text and Unicode escape sequences' },
    'ascii': { name: 'ASCII Encode/Decode', description: 'Convert between text and ASCII codes' },
    'punycode': { name: 'Punycode Encode/Decode', description: 'Convert internationalized domain names' },
    'hmac': { name: 'HMAC Calculator', description: 'Calculate HMAC message authentication codes' },
    'caesar': { name: 'ROT13/Caesar Cipher', description: 'Classic shift cipher encryption' },
    'morse': { name: 'Morse Code', description: 'Encode and decode Morse code' },
    'rail-fence': { name: 'Rail Fence Cipher', description: 'Rail fence transposition cipher encryption' },
    'base32': { name: 'Base32/Base58 Encode/Decode', description: 'Base32 and Base58 encoding converter' },
    'crc': { name: 'CRC Checksum', description: 'Calculate CRC16 and CRC32 checksums' },
    ...
    'html-to-image': { name: 'HTML to Image', description: 'Render HTML code to image' },
